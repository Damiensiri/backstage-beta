(function(){
  const APP_ID="186e6f3b-def4-4b8e-8700-650456ff93cc";
  const promptMemoryKey="backstage_beta_push_prompt_last_seen";
  ...
  function settings(){return{base:(localStorage.getItem("notifications_beta_api_url")||"https://ecurie-notifications-beta.damiensiri-pro.workers.dev").replace(/\/$/,""),token:localStorage.getItem("notifications_beta_admin_token")||""};}
  ...
  window.OneSignalDeferred.push(async OneSignal=>{
    try{
      await OneSignal.init({appId:APP_ID,notifyButton:{enable:false},welcomeNotification:{disable:true},serviceWorkerPath:"backstage-beta/OneSignalSDKWorker.js",serviceWorkerParam:{scope:"/backstage-beta/"},promptOptions:{slidedown:{prompts:[{type:"push",autoPrompt:false,text:{actionMessage:"Souhaitez-vous recevoir les notifications Backstage ?",acceptButton:"Autoriser",cancelButton:"Plus tard"}}]}}});
